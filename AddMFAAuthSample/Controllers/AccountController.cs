...
using AddMFAAuthSample.App_Start;

namespace AddMFAAuthSample.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    await UserManager.GenerateTwoFactorTokenAsync(user.Id, "EmailCode");
        ...
        {
            if (String.IsNullOrEmpty(await GetTwoFactorUserIdAsync()))
            {
